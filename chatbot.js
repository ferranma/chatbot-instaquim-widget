...
var TEXTS={
  ca:{sub:'Fabricant de productes de neteja',placeholder:'Escriu la teva consulta...',hello:'Hola! \u{1F44B} S\u00f3c l\'assistent d\'<b>Instaquim</b>, fabricant de productes qu\u00edmics de neteja des de 1990. Com et puc ajudar?',suggestions:['Productes','Marca blanca','Mostres gratu\u00eftes','Sectors','Contactar'],offline:'No he pogut connectar. Truca al <b>'+CFG.phone+'</b>.'},
  es:{sub:'Fabricante de productos de limpieza',placeholder:'Escribe tu consulta...',hello:'\u00a1Hola! \u{1F44B} Soy el asistente de <b>Instaquim</b>, fabricante de productos qu\u00edmicos de limpieza desde 1990. \u00bfEn qu\u00e9 puedo ayudarte?',suggestions:['Productos','Marca blanca','Muestras gratis','Sectores','Contactar'],offline:'No he podido conectar. Ll\u00e1manos al <b>'+CFG.phone+'</b>.'},
  en:{sub:'Cleaning products manufacturer',placeholder:'Type your question...',hello:'Hello! \u{1F44B} I\'m the <b>Instaquim</b> assistant, manufacturer of professional cleaning products since 1990. How can I help you?',suggestions:['Products','Private label','Free samples','Sectors','Contact'],offline:'Could not connect. Call us at <b>'+CFG.phone+'</b>.'},
  fr:{sub:'Fabricant de produits de nettoyage',placeholder:'\u00c9crivez votre question...',hello:'Bonjour! \u{1F44B} Je suis l\'assistant d\'<b>Instaquim</b>, fabricant de produits chimiques de nettoyage depuis 1990. Comment puis-je vous aider?',suggestions:['Produits','Marque blanche','\u00c9chantillons gratuits','Secteurs','Contact'],offline:'Impossible de se connecter. Appelez-nous au <b>'+CFG.phone+'</b>.'},
  pt:{sub:'Fabricante de produtos de limpeza',placeholder:'Escreva a sua pergunta...',hello:'Ol\u00e1! \u{1F44B} Sou o assistente da <b>Instaquim</b>, fabricante de produtos qu\u00edmicos de limpeza desde 1990. Como posso ajud\u00e1-lo?',suggestions:['Produtos','Marca branca','Amostras gr\u00e1tis','Setores','Contactar'],offline:'N\u00e3o foi poss\u00edvel conectar. Ligue para <b>'+CFG.phone+'</b>.'}
};
var T=TEXTS[lang];
